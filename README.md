...
Senior Frontend Engineer with 5+ years of experience building **scalable React applications**
for high-load production systems (10M+ users).

I focus on **frontend architecture, performance optimization**, and **shipping AI-powered
features** with measurable business impact. Comfortable owning features end-to-end —
from technical design to production delivery.
...
![Next.js](https://img.shields.io/static/v1?label=&message=Next.js&color=000000&logo=nextdotjs&logoColor=white&style=for-the-badge)
...
![GitHub Actions](https://img.shields.io/static/v1?label=&message=GitHub+Actions&color=2088FF&logo=github-actions&logoColor=white&style=for-the-badge)
![Docker](https://img.shields.io/static/v1?label=&message=Docker&color=2496ED&logo=docker&logoColor=white&style=for-the-badge)

**AI Integration**  
![OpenAI](https://img.shields.io/static/v1?label=&message=OpenAI+API&color=412991&logo=openai&logoColor=white&style=for-the-badge)
![LangChain](https://img.shields.io/static/v1?label=&message=LangChain&color=000000&logoColor=white&style=for-the-badge)
